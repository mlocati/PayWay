...
$phpCSFixerVersion = class_exists(PhpCsFixer\ToolInfo::class) ? (new PhpCsFixer\ToolInfo())->getVersion() : 'unknown';
if ($phpCSFixerVersion === 'unknown' || version_compare($phpCSFixerVersion, '3.17') < 0) {
    throw new RuntimeException("Please use PHP-CS-Fixer 3.17 or later (you are using version {$phpCSFixerVersion})");
}
